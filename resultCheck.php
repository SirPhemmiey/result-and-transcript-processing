...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="1" class="graybox">
 ...
 <tr> 
  <td valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="20">
    <tr> 
     <td class="contentArea"> <form method="post" action="resultPageS.php" name="frmLogin" id="frmLogin">
		 ...
		 <div class="errorMessage" align="center"></div>
		  ...
		  <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
           ...
           <tr>
             ...
             <td align="center">:</td>
             <td><input name="matric" type="text" class="box" id="txtUserName" size="30" maxlength="40"></td>
           </tr>
