...
<?php
$levelSem = $_GET['levSem'] ? $_GET['levSem']: '';
...
$sql ="SELECT * FROM yearone2nd WHERE matric =$matric";
	...
	extract($row);
      ...
      global $gss101,$phy101,$gss103,$mth131,$chm101,$cis101,$mth111,$bio151,$phy191,$sta111,$phy192,$phy102,$mth112,$gss102,$cis102,$sta112,$cis192,$mth113,$cis104,$gss108,$gss107;
