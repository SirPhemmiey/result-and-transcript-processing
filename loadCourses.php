         ...
         <?php //if (mysqli_num_rows($result) == 1) {?>
          ...
          <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
            ...
            <?php $count=1;  while($rows = dbFetchAssoc($result)) {?>
              ...
              <td class="content"><input disabled name="course_<?php echo $count;?>" type="text" class="box" id="GSS101" value="<?php echo $rows['CoursesName']; ?>" size="15" maxlength="8" />
              <?php echo $rows['units']?> Units
              </td>
              <input name="course_<?php echo $count;?>" type="hidden" value="<?php echo $rows['id']; ?>" />
