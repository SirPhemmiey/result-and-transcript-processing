...
function resultCheck(){
	...
	var check = confirm('Please Note: This window is only for result Checking.Pls Click okay if you wish to continue');
	if(check==true)
       ...
       <table width="350" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#336699" class="entryTable">
        ...
        <option value="student">&nbsp;&nbsp; Student &nbsp;</option>            
           ...
           <!-- <tr> -->
           	 <!-- <tr>
             <td colspan="2">&nbsp;</td>
             <td ><div align="right">New Student <a href="register.php">Register Here</a> </div></td>
           </tr> -->
             <!-- <tr>
